...
(function() {
  ...
  Ratestate = (function() {
    ...
    Ratestate.prototype.run = function() {
      var desiredHash, desiredState, entityId, i, len, _i, _results;
        ...
        if (this._currentHashes[entityId] !== this._desiredHashes[entityId]) {
          ...
          this._config.worker(entityId, desiredState, (function(_this) {
            return function(err) {
              ...
              if (_this._entityStateCallbacks[entityId][desiredHash] != null) {
                _this._entityStateCallbacks[entityId][desiredHash](err);
              }
              if (!err) {
