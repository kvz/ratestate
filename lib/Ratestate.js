...
(function() {
  ...
  Ratestate = (function() {
    ...
    Ratestate.prototype.setState = function(entityId, desiredState, cb) {
      var desiredHash, desiredStateCopy;
      desiredStateCopy = JSON.parse(JSON.stringify(desiredState));
      desiredHash = this._config.hashFunc(desiredStateCopy);
      ...
      if (indexOf.call(this._entityIds, entityId) < 0) {
    ...
    Ratestate.prototype.run = function() {
      var cb, cbs, checked, desiredHash, desiredState, entityId, i, j, k, len, ref, ref1;
      checked = 0;
      for (i = j = ref = this._pointer, ref1 = this._entityIds.length - 1; ref <= ref1 ? j <= ref1 : j >= ref1; i = ref <= ref1 ? ++j : --j) {
            ...
            return function(err) {
              ...
              if (cbs != null) {
                ...
                for (k = 0, len = cbs.length; k < len; k++) {
                  cb = cbs[k];
                  results.push(cb(err, desiredState));
                }
                return results;
              }
            };
        ...
        if ((cbs != null) && !this._workerInProgress[entityId]) {
          this._entityStateCallbacks[entityId] = [];
          for (k = 0, len = cbs.length; k < len; k++) {
            cb = cbs[k];
...
//# sourceMappingURL=Ratestate.js.map
