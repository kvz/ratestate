...
(function() {
  ...
  Ratestate = (function() {
    Ratestate.prototype._desiredStates = {};

    Ratestate.prototype._currentHashes = {};

    Ratestate.prototype._desiredHashes = {};

    Ratestate.prototype._objectIds = [];

    Ratestate.prototype._pointer = 0;

    Ratestate.prototype._config = {
      interval: 30,
    ...
    Ratestate.prototype.getState = function(objectId) {
      return this._desiredStates[objectId];
    };
